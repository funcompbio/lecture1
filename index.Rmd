...
* All sessions will be _presential_ unless COVID19 restrictions are enforced
  by health authorities. In such a case we will go online-synchronous by videocall
  (Zoom or Google Meet).
* There will be no _hybrid_ sessions, i.e., simultaneous _presential_ and
  _videocall_, although recorded videos from last year may be available.
...
* Continuous evaluation:
  * Seminars through a test on programming problem solving (1 point on the final
    grade): **November 5th, 08:30-09:30**
...
[https://github.com/funcompbio](https://github.com/funcompbio)
...
[https://lucywan.github.io](https://lucywan.github.io)
or
...
* The UPF offers a Slack workspace called _upfbarcelona_ for all members of the
  UPF community (students, faculty, etc.); see
...
![:scale 60%](img/moodlesitewindow.png)
