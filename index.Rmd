...
* You may want to install in your computer the following software tools:
  * Unix shell: by Practical 1 on September 27th.
  * Text editor: by Practical 2 on October 3rd.
  * Git version-control system: by Practical 3 on October 9th.
  * Python and Jupyter Notebook: by Practical 4 and October 11th.
  * R and RStudio Notebook: by Practical 7 on October 31st.
...
* All the practicals will take place in computer rooms, which will be prepared
  ...
  &nbsp;&nbsp;
* For seminars 4 and 5 you will have to bring along a computer laptop, because
  they will take place in regular classrooms, but with electric sockets.  
  &nbsp;&nbsp;
* For seminars 4 and 5 yoou should bring your laptop with the necessary software
  installed and the Eduroam WiFi connection configured
...
* We have a Zulip organization for FCB associated with the URL:
  [https://fcb2023.zulipchat.com](https://fcb2023.zulipchat.com), but
