...
.pull-right[
  ...
  <br> 
  <br> 
  ![:scale 80%](img/marta.jpg)
  Marta Espinosa Camarena  
  doctoral student at
  [HMRIB](https://es.linkedin.com/in/marta-espinosa-camarena)  
  computational oncology, microproteins and cancer vaccines
]
...
* The purpose of introducing this subject at the beginning of the curriculum is
  ...
  the whole degree of
  [Biomedical Sciences](https://www.upf.edu/web/biomed/pla-estudis-ciencies-biomediques),
  and particularly in:
    - Biostatistics in the second year.
    - Systems Biology and Bioinformatics in the third year.
    - Structural biology in the fourth year.
...
* One single group-class for lectures (~ 70 students/group), two for seminars
  (~ 35 students/group), four for practicals (~ 16 students/group).  
  &nbsp;&nbsp;
* One ECTS (~ 25hrs) throughout 10 weeks:
  * 3 hrs of lectures (3 sessions)
  * 2 hrs of seminars (1 session)
  * 4 hrs of practicals (2 sessions)
  * 16 hrs of out-of-class work (study, assignments, etc.)
* FCB has 6 ECTS, 125hrs in 10 weeks (~ 12 hr/week). Because of the learning
  goals of FCB, we exchange 6 hrs of lectures and 2 hrs of practicals to have
  2 more seminars:
  * **12** lectures = 12 hrs
  * **8** seminars x 2 hrs = 16 hrs
  * **11** practicals x 2 hrs = 22 hrs
  * 12+16+22=50 hrs of class time work (~ 5 hrs/week)
  * 125-50=75 hrs of out-of-class time work (~ 7 hrs/week)
...
* Continuous evaluation:
  * Seminars through a test on programming problem solving (2 points on the final
    grade): **Friday February 6th 09:30-10:30**
  * Practicals through the submission of computer assignments (2 points on the
    ...
    submissions.
  * Data analysis project (2 points on the final grade): ~ 14hrs work including
    3 seminars, submission deadline on March 10th, penalty for late submissions.
...
.pull-left[
* Letting AI tools such as ChatGPT or Gemini to entirely do your homework,
  is akin to *"outsourcing your brain to these tools"*
  ([Daniela Witten, *ChatGPT ate my homework*, 2025](https://imstat.org/2025/11/15/written-by-witten-chatgpt-ate-my-homework)).  
  &nbsp;&nbsp;
* Your goal should not be to reach a specific mark, your goal should be
  **learning**.
]
...
.footer[[Image by Elliott Hedman](https://www.buildempathy.com/human-ai-interactions/aiabstinence).]
...
.pull-left[
* We will introduce AI
  [pair programming](https://en.wikipedia.org/wiki/Pair_programming), where you
  work alongside an AI coding assistant to help you develop faster and better
  code.  
  &nbsp;&nbsp;
* AI pair programming can only help as long as you have basic problem solving
  skills that allow you to evaluate what the AI assistant is proposing you to do.  
  &nbsp;&nbsp;
* We will be using [GitHub Copilot](https://github.com/features/copilot), which
  is a AI coding assistant specifically developed for programming, and has
  become an industry standard.

]

.pull-right[
![AIGym](img/sportswearabletech.jpg)
]

.footer[[Image by TeamScaler](https://www.teamscaler.co/blog/the-power-of-wearable-technology-in-sports-and-everyday-life).]

---

# Software tooling

* All practicals, except group 101 in practical 5, will take place in a
  computer room.  
  &nbsp;&nbsp;
* However, in seminars 4, 5 and 6, you should bring your own device, or
  borrow one from the library.  
  &nbsp;&nbsp;
* While you may use computer rooms from all UPF campuses, you may want
  to work at home with your own device.  
  &nbsp;&nbsp;
* You may want to install in your computer the following software tools:
  * Unix shell: by Practical 1 on January 8th.
  * Text editor: by Practical 2 on January 13th.
  * Git version-control system: by Practical 3 on January 15th.
  * Python: by Practical 4 and January 21st.
  * R and RStudio Notebook: by Practical 7 on February 10th.
...
* We have a Zulip organization for FCB associated with the URL:
  [https://fcb2026.zulipchat.com](https://fcb2026.zulipchat.com), but
...
* Office hours: Zulip is the preferred and quicker way to have
  *office hours*, will try to answer within one business day.  
  &nbsp;&nbsp;
* In-person office hours: Monday's mornings, from 11:00 to 13:00, PRBB Building
